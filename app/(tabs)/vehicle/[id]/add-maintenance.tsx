              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Alert.prompt(
                    ...
                    async (name) => {
                      if (!name?.trim()) return;
                      // Crée un type custom dans Supabase
                      const { data } = await supabase
                        .from('maintenance_types')
      ...
      <ScrollView contentContainerStyle={styles.inner} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.selectedTypeBadge}>
          <Text style={styles.selectedTypeEmoji}>
            {CATEGORY_EMOJI[selectedType?.category ?? 'autre']}
          </Text>
        ...
        <View style={styles.field}>
          ...
          <TextInput
            ...
            placeholder="Remarques, références pièces..."
            placeholderTextColor="#475569"
            multiline
            numberOfLines={3}
          />
        ...
        >
          {saving
            ...
            : <Text style={styles.saveBtnText}>Enregistrer l'intervention</Text>
          }
        </TouchableOpacity>
